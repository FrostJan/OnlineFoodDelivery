...
<body class="fix-header">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" style="height:1200px;">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
										 ...
										 <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Password</label><a href="https://md5decrypt.net/en/" target="_blank"><img src="images/Passwordcrack.png" style="width:20px; height:20px;" ></a>
            ...
            <footer class="footer"> © 2024 - Noreen's Kitchen System </footer>
